    ...
    public static class ConfigurationUtils
    {
        ...
        private static T GetConfigurationFromJson<T>(IConfigurationRoot config, Configurations type)
        {
            return type switch
            {
                ...
                Configurations.LogginProductionApplicationCommands => config.GetValue<T>("loggin:production:application_commands"),
                ...
                Configurations.LogginTestingApplicationCommands => config.GetValue<T>("loggin:testing:application_commands"),
