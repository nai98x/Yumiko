...
namespace Yumiko.Utils
{
    public static class LogUtils
    {
        ...
        public static string GetContextMenu(ContextMenuExecutedEventArgs e)
        {
            return $"/{e.Context.CommandName}";
        }
        ...
        public static DiscordEmbedBuilder LogContextMenuError(ContextMenuErrorEventArgs e)
        {
            var builder = new DiscordEmbedBuilder()
            {
                Title = "Context menu error",
                Description = GetErrorString(e),
                Color = DiscordColor.Red
            };
        ...
        private static string GetErrorString(ContextMenuErrorEventArgs e)
        {
            string desc = $"{e.Exception.Message}\n{Formatter.BlockCode(e.Exception.StackTrace)}";
            switch (e.Exception)
            {
