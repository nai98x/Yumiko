namespace Yumiko.Commands
{
    ...
    public class Games : ApplicationCommandModule
    {
        ...
        [SlashCommand("stats", "	Shows the statistics of the different games")]
        [SlashRequirePermissions(Permissions.SendMessages)]
        public async Task Stats(InteractionContext ctx, [Option("Game", "The type of game you want to see the stats")] Gamemode gamemode)
        {
            await ctx.CreateResponseAsync(InteractionResponseType.DeferredChannelMessageWithSource);
            var context = ctx;
            var interactivity = ctx.Client.GetInteractivity();
        ...
        [SlashCommand("statshol", "Shows the statistics of the Higher or Lower game")]
        [SlashRequirePermissions(Permissions.SendMessages)]
        public async Task StatsHoL(InteractionContext ctx)
        {
            await ctx.CreateResponseAsync(InteractionResponseType.DeferredChannelMessageWithSource);
        ...
        [SlashCommand("deletestats", "Deletes user statistics on the guild")]
