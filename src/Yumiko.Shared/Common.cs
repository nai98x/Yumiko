...
public static class Common
{
    ...
    */
    ...
    {
        await Program.LogChannelErrors.SendMessageAsync(new Embed
        {
            Title = "Unknown error",
            Description = description,
    ...
    */
    ...
    /// <summary>
    /// Makes an NSFW warning <see cref="Embed"/>.
    /// </summary>
    public static Embed NsfwWarning { get; private set; } = new Embed
    {
    ...
    /// <summary>
    /// Makes an resource not found <see cref="Embed"/>.
    /// </summary>
    public static Embed ResourceNotFound(string resource)
    {
        return new Embed
        {
